...
// ResourceRepository implements the ResourceRepository interface for the Maven access type.
type ResourceRepository struct{}

// NewResourceRepository creates a new Maven resource repository.
...
// GetResourceRepositoryScheme returns the scheme used by the Maven resource repository.
...
func (r *ResourceRepository) GetResourceCredentialConsumerIdentity(ctx context.Context, resource *descriptor.Resource) (runtime.Identity, error) {
	...
	identity.SetType(runtime.NewUnversionedType(accessspec.MavenConsumerType))

	return identity, nil
}

// DownloadResource downloads a resource described by the Maven access spec.
//
...
func (r *ResourceRepository) DownloadResource(ctx context.Context, resource *descriptor.Resource, credentials runtime.Typed) (blob.ReadOnlyBlob, error) {
	...
	return nil, fmt.Errorf("DownloadResource is not implemented for the Maven access type")
}

// UploadResource is not supported for the Maven access type.
func (r *ResourceRepository) UploadResource(ctx context.Context, res *descriptor.Resource, content blob.ReadOnlyBlob, credentials runtime.Typed) (*descriptor.Resource, error) {
	return nil, fmt.Errorf("upload is not supported for the Maven access type")
}
...
// ProcessResourceDigest computes the digest of a Maven resource.
//
...
func (r *ResourceRepository) ProcessResourceDigest(ctx context.Context, resource *descriptor.Resource, credentials runtime.Typed) (*descriptor.Resource, error) {
	return nil, fmt.Errorf("ProcessResourceDigest is not implemented for the Maven access type")
}
